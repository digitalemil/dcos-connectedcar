...
View.prototype.init = function() {
	...
	console.log("Timer: "+Math.round(1000 / this.dfps));
...
View.prototype.paintQuad = function(d, teximg, w, h, r) {
	...
	this.ctx.translate(xmin + w2+ teximg.width/2, h2+ ymin+ teximg.height/2);
	...
	//	console.log("Painting Thing: "+t);
		...
		//	console.log("Paint id: "+tex);
			...
			this.paintQuad(this.modell.getData(t), teximg,
					this.modell.getImageWidth(t), this.modell.getImageHeight(t), this.modell.getRotation(t));
	//		console.log(this.modell.getImageWidth(t)+" "+ this.modell.getImageHeight(t))
		} else {
			if (ft == false) {
				ft = true;
