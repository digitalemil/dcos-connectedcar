...
var img0 = new ImageThing("http://digitalemil.de/hortonsgym/cc00.png",
		640 * scale, 960 * scale);
var img1 = new ImageThing("http://digitalemil.de/hortonsgym/cc01.png",
		640 * scale, 960 * scale);
...
function postData() {
	...
	if (req) {
		...
		var now = new Date;
		var utc_timestamp = now.getUTCFullYear() + "-" + (1+now.getUTCMonth())
		+ "-" + now.getUTCDate() + "T" + now.getUTCHours() + ":"
		+ now.getUTCMinutes() + ":" + now.getUTCSeconds() + "Z";
var json = "{'id':'" + user+"-"+utc_timestamp
